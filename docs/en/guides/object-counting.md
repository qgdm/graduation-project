...
count_objects_in_region("path/to/video.mp4", "output_video.avi", "normal.pt")
```
...
count_specific_classes("path/to/video.mp4", "output_specific_classes.avi", "normal.pt", [0, 2])
```
