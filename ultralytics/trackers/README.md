...
model = YOLO("normal.pt")  # Load an official Detect model
...
yolo track model=normal.pt source="https://youtu.be/LNwODJXcvt4"  # Official Detect model
...
yolo track model=normal.pt source="https://youtu.be/LNwODJXcvt4" conf=0.3, iou=0.5 show
```
...
yolo track model=normal.pt source="https://youtu.be/LNwODJXcvt4" tracker='custom_tracker.yaml'
```
