...
class Model(nn.Module):
    ...
    def __init__(
        self,
        model: Union[str, Path] = "normal.pt",
        task: str = None,
        verbose: bool = False,
    ) -> None:
        """
    ...
    def is_triton_model(model: str) -> bool:
        ...
        Examples:
            ...
            True
            >>> Model.is_triton_model("normal.pt")
            False
        """
    ...
    def load(self, weights: Union[str, Path] = "normal.pt") -> "Model":
        """
