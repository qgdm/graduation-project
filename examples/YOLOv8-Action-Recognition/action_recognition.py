...
def run(
    ...
    Args:
        weights (str): Path to the YOLO model weights. Defaults to "normal.pt".
...
def parse_opt():
    ...
    parser.add_argument("--weights", type=str, default="normal.pt", help="ultralytics detector model path")
